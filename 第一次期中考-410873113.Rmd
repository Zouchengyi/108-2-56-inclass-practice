...
chr_receipts300 <- as.character(receipts300)

as.integer(chr_receipts300)-> chr_receipts300
sum(as.integer(chr_receipts300))
sum300 <- sum(as.integer(chr_receipts300))
#sum300
```
...
```{r ans35}
post[[4]] <- list(category="臺北大學"),
         list(DateTime ="4月20日 14:44")
str(post)
# post
```
