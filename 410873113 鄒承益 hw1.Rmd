...
```{r ans22}
two_times<- c(ymd_hms("2019-4-12 12:55:30",tz="Asia/taipei"),
            ymd_hms("2018-11-18 15:33:02",tz="Europe/oslo"))
...
```{r ans44}
sum(as.integer(chr_fiveReceipts))
sum_fiveReceipts<-sum(as.integer(chr_fiveReceipts))
...
```{r data5}
# 啟動一個乾淨空的R環境
source("https://www.dropbox.com/s/xtge2ghfb7dhple/108-2-hw1-4.R?dl=1",print.eval = T) 
